...
{
    /*
    Представьте, что у нас есть группа людей, которые хотят общаться друг с другом через чат-комнату.
    Посредник в этом случае будет отвечать за передачу сообщений между участниками чата.
    */
