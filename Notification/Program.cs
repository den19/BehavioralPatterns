...
{
    /*
    Предположим, у нас есть система, состоящая из множества модулей, которые должны обмениваться уведомлениями о событиях.
    Посредник организует централизованное управление этими уведомлениями. 
    */
